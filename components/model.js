...
export const RenderModel = (props) => {
    ...
    const [f, setF] = useState({a: 'Firebird', b: 'Fury'})
    ...
    const [s, setS] = useState({a: 'Satellite', b: 'Sport Fury'})
        ...
        <div className={styles.flexModel}>
                ...
                <div className={styles.flexModelChild}>
                    ...
                    <div>
                        ...
                        <ul>      
                            ...
                            <li onClick={e => props.showModel(e.target.innerText)}>{f.b}</li>
                        </ul>
                    </div>
                    <div>
            ...
            <div>
                ...
                <ul>
                    ...
                    <li onClick={e => props.showModel(e.target.innerText)}>{s.b}</li>
                </ul>
            </div>
            <div>
